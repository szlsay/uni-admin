	...
	<view class="uni-container">
		<uni-forms ref="form" :model="formData" validateTrigger="bind">
			...
			<uni-forms-item name="device_type" label="设备类型">
				<uni-data-checkbox v-model="formData.device_type"
					:localdata="formOptions.device_type_localdata"></uni-data-checkbox>
			</uni-forms-item>
...
<script>
	import {
		validator
	} from '@/js_sdk/validator/lk-mall-banner.js';
	...
	export default {
		...
		methods: {
			...
			getDetail(id) {
				...
				db.collection(dbCollectionName).doc(id).field("update_time,image,url,device_type").get().then((res) => {
