<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" :collection="collectionList" field="update_time,image,url,device_type" :where="where" page-data="replace"
        ...
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
          ...
          <uni-tr v-for="(item,index) in data" :key="index">
            ...
            <uni-td align="center">{{options.device_type_valuetotext[item.device_type]}}</uni-td>
            <uni-td align="center">
              <view class="uni-group">
...
<script>
  import { enumConverter, filterToWhere } from '@/js_sdk/validator/lk-mall-banner.js';
