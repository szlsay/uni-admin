...
<script>
	import {
		validator
	} from '@/js_sdk/validator/lk-mall-aftersaleaddress.js';
	...
	export default {
		...
		methods: {
			...
			getDetail(id) {
				...
				db.collection(dbCollectionName).doc(id).field("contact_name,contact_tel,area_code,zip_code,address,province_name,province_code,city_name,city_code,area_name").get().then((
					res) => {
