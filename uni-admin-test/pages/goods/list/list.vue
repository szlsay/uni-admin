	...
	<view>
		...
		<view class="uni-container">
			<unicloud-db ref="udb" :collection="collectionList"
				field="name,goods_desc,goods_thumb,remain_count,last_modify_date" :where="where" page-data="replace"
				...
				<uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection"
					...
					<uni-tr>
						...
						<uni-th align="center" filter-type="search" @filter-change="filterChange($event, 'goods_desc')" sortable
							@sort-change="sortChange($event, 'goods_desc')">详细描述</uni-th>
						<uni-th align="center" sortable @sort-change="sortChange($event, 'goods_thumb')">商品图片</uni-th>
						<uni-th align="center" filter-type="range" @filter-change="filterChange($event, 'remain_count')" sortable
							@sort-change="sortChange($event, 'remain_count')">库存数量</uni-th>
						<uni-th align="center" filter-type="timestamp" @filter-change="filterChange($event, 'last_modify_date')"
							sortable @sort-change="sortChange($event, 'last_modify_date')">last_modify_date</uni-th>
